...
export const PROJECTS: Project[] = [
    {
        ...
        modalContent: {
            ...
            architecture: {
                title: "아키텍처 구조",
                summary: "사용자 화면에서 시작된 주문과 결제 흐름이 인증, 상품, 주문, 결제, 예치금 같은 서비스로 나뉘어 처리되고, 서비스 간 상태 변화는 Kafka 이벤트로 연결되는 구조입니다.",
                imageSrc: "/images/projects/dukku/architecture-thumb.svg",
                imageAlt: "DUKKU 아키텍처 구조도",
                diagram: [
                    {
                        label: "사용자 화면",
                        description: "Vite + React 프론트엔드에서 상품 탐색, 장바구니, 주문, 결제, 관리자 기능을 하나의 사용자 흐름으로 제공합니다.",
                    },
                    {
                        label: "도메인 서비스",
                        description: "`auth`, `user`, `product`, `order`, `coupon`, `payment`, `deposit`, `settlement`, `ai` 서비스가 역할을 나눠 처리하고 공통 설정은 `common` 모듈에서 공유합니다.",
                    },
                    {
                        label: "이벤트 흐름",
                        description: "결제 완료, 쿠폰 사용, 예치금 차감, 환불 같은 상태 변화는 Kafka 이벤트로 전달돼 서비스 간 후속 처리를 이어갑니다.",
                    },
                    {
                        label: "데이터와 운영 환경",
                        description: "PostgreSQL, Redis, Elasticsearch, 오브젝트 스토리지 위에서 동작하고, Kubernetes, Nginx, Prometheus, Grafana, MongoDB 구성이 운영 환경을 받쳐줍니다.",
                    },
                ],
                highlights: [
                    "주문, 결제, 예치금, 쿠폰 흐름을 서비스 단위로 분리하고 Kafka 이벤트로 연결해 서비스 간 후속 처리를 이어가도록 구성했습니다.",
                    "공통 모듈에서 인증, 보안, Kafka, 내부 서비스 호출 규칙을 공유해 여러 서비스가 같은 기준으로 동작하도록 맞췄습니다.",
                    "상품 검색은 Elasticsearch, 결제는 Toss 연동, 운영 관측은 Prometheus, Grafana, MongoDB 기반으로 구성했습니다.",
                ],
            },
            caseStudies: [
                {
                    ...
                    result: [
                        "초반 구현 속도를 유지하면서도 Final 단계에서 비교적 자연스럽게 MSA로 이행할 수 있었습니다.",
                        "구조를 어떤 시점에 어떤 수준으로 도입할지 판단하는 경험을 얻었고, 이를 기반으로 아키텍처 전환은 기술 자체보다 도입 시점이 더 중요하다는 점을 느꼈습니다.",
                    ],
                },
                {
                    ...
                    result: [
                        "분산 환경에서 발생할 수 있는 정합성, 멱등성, 동시성 문제를 제어할 수 있었습니다.",
                        "MSA 환경에서 어떤 패턴을 어떤 상황에 적용해야 하는지 직접 다루는 경험을 얻었고, 이를 기반으로 트랜잭션보다 보상 흐름 설계가 더 중요하다는 점을 느꼈습니다.",
                        // 정량적 성과로 보완 필요
                    ],
                },
                {
                    ...
                    result: [
                        "7일가량 걸리던 사전 기획 구간을 3일 수준으로 줄일 수 있었습니다.",
                    ],
                },
                {
                    ...
                    result: [
                        "사양이 부족한 팀원도 테스트 가능한 수준의 메모리를 확보할 수 있었습니다.",
                    ],
                },
            ],
        },
    },
    {
        ...
        modalContent: {
            ...
            architecture: {
                title: "아키텍처 구조",
                summary: "사용자가 부트캠프 정보를 탐색하고 후기를 남기는 흐름과, 관리자가 기관과 리뷰를 승인하는 운영 흐름을 하나의 서비스 안에서 함께 처리하는 구조입니다.",
                imageSrc: "/images/projects/softwarecampus/architecture-thumb.svg",
                imageAlt: "SoftwareCampus 아키텍처 구조도",
                diagram: [
                    {
                        label: "사용자 화면",
                        description: "React 프론트엔드에서 과정 탐색, 후기 작성, 커뮤니티, 마이페이지, 관리자 화면까지 하나의 웹 경험으로 제공합니다.",
                    },
                    {
                        label: "서비스 백엔드",
                        description: "Spring Boot 백엔드가 과정, 후기, 커뮤니티, 기관 등록과 승인, 회원 관리 기능을 단일 애플리케이션 안에서 처리합니다.",
                    },
                    {
                        label: "권한과 운영 기능",
                        description: "관리자, 기관, 일반 사용자 권한을 분리해 승인 요청, 운영 화면, 일반 사용자 기능이 서로 다른 정책으로 동작하도록 구성했습니다.",
                    },
                    {
                        label: "데이터와 배포 환경",
                        description: "MySQL, Redis, 객체 스토리지 위에서 동작하고 Docker Compose와 Nginx 기반 배포 구성이 운영 환경을 받쳐줍니다.",
                    },
                ],
                highlights: [
                    "관리자, 기관, 일반 사용자 권한을 분리하고 화면 노출과 API 접근 제어를 함께 맞춰 운영 기능과 사용자 기능이 섞이지 않도록 구성했습니다.",
                    "JWT 인증, 이메일 인증, 파일 업로드, Redis 기반 캐시와 로그인 시도 제어를 함께 두어 서비스 운영에 필요한 공통 기능을 백엔드에 통합했습니다.",
                    "MySQL, Redis, 객체 스토리지, Docker Compose 기반 배포 구성을 조합해 사용자 서비스와 관리자 운영 기능을 같은 제품 안에서 안정적으로 운영할 수 있게 했습니다.",
                ],
            },
            caseStudies: [
                {
                    ...
                    result: [
                        "운영 주체가 바뀌더라도 관리 가능한 납품형 인프라 구성을 마련할 수 있었습니다.",
                        "운영 권한 구조까지 설계하는 경험을 얻었고, 이를 기반으로 애플리케이션 구현만큼 운영 책임 분리가 중요하다는 점을 느꼈습니다.",
                    ],
                },
                {
                    ...
                    result: [
                        "계정 유형별로 구분된 관리자 기능이 실제 서비스 안에서 동작하도록 구현했습니다.",
                        "데이터 승인과 운영 업무가 서비스 내부에서 처리되는 구조를 설계하는 경험을 얻었고, 이를 기반으로 운영 기능도 제품 기능처럼 설계되어야 한다는 점을 느꼈습니다.",
                    ],
                },
                {
                    ...
                    result: [
                        "역할별 정책이 실제 기능 단위에서 일관되게 적용되도록 만들 수 있었습니다.",
                        "권한이 얽힌 운영 기능을 설계하는 경험을 얻었고, 이를 기반으로 인증/인가와 데이터 처리 정책은 함께 설계되어야 한다는 점을 느꼈습니다.",
                    ],
                },
            ],
        },
...

    {
        ...
        modalContent: {
            ...
            architecture: {
                title: "아키텍처 구조",
                summary: "워크스페이스 안에서 팀 생성, 칸반, 일정, 채팅, 화상회의까지 이어지는 협업 흐름을 하나의 서비스 안에 묶고, 실시간 기능은 알림과 양방향 통신을 나눠 처리하는 구조입니다.",
                imageSrc: "/images/projects/pick-team/architecture-thumb.svg",
                imageAlt: "Pick Team 아키텍처 구조도",
                diagram: [
                    {
                        label: "협업 화면",
                        description: "React 프론트엔드에서 워크스페이스, 팀스페이스, 칸반, 일정, 채팅, 화상회의 화면을 하나의 협업 경험으로 제공합니다.",
                    },
                    {
                        label: "서비스 백엔드",
                        description: "Spring Boot 백엔드가 워크스페이스, 팀, 게시판, 칸반, 일정, 채팅, 사용자 관리 도메인을 단일 애플리케이션 안에서 처리합니다.",
                    },
                    {
                        label: "실시간 기능",
                        description: "채팅 알림은 SSE, 채팅과 화상회의 제어는 WebSocket STOMP, 화상회의 미디어 처리는 LiveKit으로 나눠 실시간 흐름을 구성했습니다.",
                    },
                    {
                        label: "데이터와 배포 환경",
                        description: "MySQL과 Redis를 기본 데이터 계층으로 두고 Docker Compose에서 백엔드, Redis, LiveKit 컨테이너를 함께 운영합니다.",
                    },
                ],
                highlights: [
                    "실시간 기능을 한 가지 방식으로 몰지 않고, 알림은 SSE, 채팅과 화상회의 제어는 WebSocket STOMP, 미디어 처리는 LiveKit으로 역할을 나눠 구성했습니다.",
                    "워크스페이스, 팀, 게시판, 칸반, 일정, 채팅 기능을 단일 백엔드 안에서 관리해 협업 기능이 한 흐름으로 이어지도록 설계했습니다.",
                    "MySQL, Redis, Docker Compose, 배포 파이프라인을 함께 두어 실시간 기능과 협업 기능을 운영 가능한 형태로 묶었습니다.",
                ],
            },
            caseStudies: [
                {
                    ...
                    result: [
                        "메시지를 보내는 즉시 상대방 화면이 갱신되는 실시간 메신저를 구현할 수 있었습니다.",
                    ],
                },
                {
                    ...
                    result: [
                        "사람 손으로 반복하던 배포를 GitHub Actions 기반 자동화 파이프라인으로 전환할 수 있었습니다.",
                        "실패 지점을 직접 추적하고 수정하는 경험을 얻었고, 이를 기반으로 자동화는 구축보다 안정화 과정이 더 중요하다는 점을 느꼈습니다.",
                    ],
                },
                {
                    ...
                    result: [
                        ...
                        "협업 파이프라인을 직접 운영하는 경험을 얻었고, 이를 기반으로 브랜치 전략과 리뷰 흐름이 팀 생산성에 큰 영향을 준다는 점을 느꼈습니다.",
                    ],
                },
                {
                    title: "Soft-delete 정책 변경으로 LAZY 로딩 제약을 해소하고 삭제 제어권 확보",
                    problem: [
                        "초기에는 Hibernate 6.4의 `@SoftDelete`로 삭제 데이터를 자동 필터링해 조회 조건 반복을 줄이려 했지만, LAZY 로딩과 충돌해 연관관계가 많은 도메인에서는 설계 제약이 커졌습니다.",
                    ],
                    solution: [
                    ...
                    result: [
                        ...
                        "삭제 정책을 JPA 동작 특성에 맞게 다시 설계하는 경험을 얻었고, 이를 기반으로 편의성보다 도메인 제어권이 더 중요할 수 있다는 점을 느꼈습니다.",
                    ],
                },
                {
                    ...
                    result: [
                        "EC2 유지비 없이 서비스를 계속 운영할 수 있는 구조로 이전할 수 있었습니다.",
                        "인프라 이전과 외부 노출 구조를 다시 설계하는 경험을 얻었고, 이를 기반으로 운영 비용과 네트워크 단순성이 장기 유지보수에 큰 영향을 준다는 점을 느꼈습니다.",
                    ],
                },
            ],
        },
